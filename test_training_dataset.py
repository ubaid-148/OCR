...
class TrainingDatasetTests(unittest.TestCase):
    ...
    def test_validator_flags_shape_but_preserves_printed_arithmetic_warning(self):
        ...
        annotation.update(verified=True, verified_by="reviewer", include_in_training=True)
    ...
    def test_private_export_and_scoring(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            for index in range(9):
                ...
                record = {"doc_id": doc_id, "source_filename": f"{index}.pdf", "source_path": f"/{index}.pdf", "source_sha256": f"hash-{index}", "pages": [str(image)]}
